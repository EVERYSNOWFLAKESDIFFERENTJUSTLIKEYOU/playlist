...
//Set up event listener for play button to handle individual song selection
...
function update_second() {
    ...
    total_duration.textContent = `${durationMinutes}:${durationSeconds < 0 ? '0' : ''}${durationSeconds}`;
    ...
    current_duration.textContent = `${curr_minutes}:${curr_seconds < 0 ? '0' : ''}${curr_seconds}`;
